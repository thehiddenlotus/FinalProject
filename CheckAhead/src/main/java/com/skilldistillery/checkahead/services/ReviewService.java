...
public interface ReviewService {
	...
	Review createReview(Review review, Integer locationId, Integer cleanRating, Integer trafficRating, Integer checkoutRating, Integer stockRating, String username);
